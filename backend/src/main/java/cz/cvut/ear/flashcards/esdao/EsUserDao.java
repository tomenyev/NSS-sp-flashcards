...
@Repository
public class EsUserDao extends BaseDao<User> {
    private final String INDEX = "userdata";
    private final String TYPE = "users";

    public EsUserDao(ObjectMapper objectMapper, RestHighLevelClient restHighLevelClient) {
    ...
    public User insert(User entity, String id) {
        return super.insert(entity, id, INDEX, TYPE);
    }

    public Map<String, Object> update(String id, User entity) {
